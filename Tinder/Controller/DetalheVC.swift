...
//  Tinder
//
//  Created by Gabriel Cavalheiro on 22/02/22.
//
...
class DetalheVC: UICollectionViewController, UICollectionViewDelegateFlowLayout{
    ...
    var superLikeButto: UIButton = .iconFooter(named: "icone-superlike")
    ...
    func adicionarVoltar () {
        ...
        voltarButton.frame = CGRect(x: view.bounds.width + 120,
                                    y: view.bounds.height * 0.7 - 69,
                                    width: 48,
                                    height: 48
        )
